...
nonsez_df %>%
  ...
  labs(x = NULL,
       y = "NTL Radiance",
       title = "Average nighttime lights across Myanmar, excluding special economic zones") +
  theme_manual
```
...
ntl_gdp_df %>%
  ...
  labs(title = "Correlation between quarterly GDP and NTL",
       x = "Nighttime lights",
       y = "GDP") +
  theme_manual
...
ntl_gdp_df %>%
  ...
  geom_smooth(method = "lm",
              se = F) +
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.01) +
  labs(title = "Correlation between quarterly Manufacturing GDP and SEZ NTL",
       x = "SEZ Nighttime lights",
       y = "Manufacturing GDP") +
  theme_manual
...
ntl_gdp_df %>%
  ...
  geom_smooth(method = "lm",
              se = F) +
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.01) +
  labs(title = "Correlation between GDP and non-border NTL",
       x = "Non-Border Nighttime lights",
       y = "GDP") +
  theme_manual
